...
namespace L02_Controls
{
    public partial class L02ControlsViewController : UIViewController
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            UISlider slider = new UISlider(new CGRect(0, 0, MyView.Frame.Width - 20, 50));
            ...
            var mySwitch= new UISwitch(new CGRect(0, 0, 100, 30));
            mySwitch.ValueChanged += (sender, e) =>
            {
                this.lblText.Text = string.Format("UISwitch數值為{0}", mySwitch.On ? "ON" : "OFF");
            };

            var progress = new UIProgressView(new CGRect(0, 0, MyView.Frame.Width - 20, 100));
